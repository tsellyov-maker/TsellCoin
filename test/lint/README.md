...
maintained:
* for `src/crc32c`: https://github.com/tsellcoin-core/crc32c-subtree.git (branch tsellcoin-fork)
* for `src/crypto/ctaes`: https://github.com/tsellcoin-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/tsellcoin-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/tsellcoin-core/leveldb-subtree.git (branch tsellcoin-fork)
* for `src/minisketch`: https://github.com/tsellcoin-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/tsellcoin-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/tsellcoin-core/secp256k1.git
```
