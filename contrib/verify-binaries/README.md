...
As of TsellCoin Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/tsellcoin-core/guix.sigs/). When
...
builder-keys](https://github.com/tsellcoin-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://tsellcoincore.org and https://tsellcoin.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/tsellcoin-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/tsellcoin-24.0.1-arm-linux-gnueabihf.tar.gz
```
