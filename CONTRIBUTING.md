Contributing to TsellCoin Core
============================

The TsellCoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "TsellCoin Core
...
Before you start contributing, familiarize yourself with the TsellCoin Core build
system and tests. Refer to the documentation in the repository on how to build
TsellCoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/tsellcoin/tsellcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/tsellcoin/tsellcoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the [TsellCoin Core PR Review Club](https://tsellcoincore.reviews/).
...
Most communication about TsellCoin Core development happens on IRC, in the
`#tsellcoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#tsellcoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/tsellcoin-core-dev/](https://www.erisian.com.au/tsellcoin-core-dev/)
and [https://gnusha.org/tsellcoin-core-dev/](https://gnusha.org/tsellcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/tsellcoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/tsellcoindev/](https://gnusha.org/pi/tsellcoindev/).
...
For GUI-related issues or pull requests, the https://github.com/tsellcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/tsellcoin/tsellcoin node repository should be used.
...
the pull request affects. Valid areas are:
  ...
  - `qt` or `gui` for changes to tsellcoin-qt
...
fork of TsellCoin Core copies the merge. Instead, make any username mentions in a
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/tsellcoin/tsellcoin  # Fetch the latest upstream commit
...
The following applies to code changes to the TsellCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall TsellCoin
Network Protocol consensus changes.

Whether a pull request is merged into TsellCoin Core rests with the project merge
maintainers.
...
Patches that change TsellCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TsellCoin consensus, it must have been
...
https://github.com/tsellcoin/tsellcoin/pull/16189).

Also see the [backport.py script](
https://github.com/tsellcoin-core/tsellcoin-maintainer-tools#backport).
