...
TsellCoin Core version *version* is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-*version*/>
...
TsellCoin Core is supported and tested on the following operating systems or newer:
Linux Kernel 3.17, macOS 14, and Windows 10 (version 1903). TsellCoin
