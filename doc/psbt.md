# PSBT Howto for TsellCoin Core

Since TsellCoin Core 0.17, an RPC interface exists for Partially Signed TsellCoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/tsellcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for TsellCoin transactions that are not fully signed
...
#### Multisig with multiple TsellCoin Core instances
