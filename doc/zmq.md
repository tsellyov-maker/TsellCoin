...
The TsellCoin Core daemon can be configured to act as a trusted "border
router", implementing the tsellcoin wire protocol and relay, making
...
The ZeroMQ feature in TsellCoin Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ tsellcoind -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=unix:/tmp/tsellcoind.tx.raw \
...
From the perspective of tsellcoind, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into tsellcoind directly. Furthermore, no information is
...
using. TsellCoind appends an up-counting sequence number to each
