...
Assumeutxo is a feature that allows fast bootstrapping of a validating tsellcoind
instance.
...
```
$ tsellcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ tsellcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
