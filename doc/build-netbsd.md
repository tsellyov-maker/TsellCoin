...
This guide describes how to build tsellcoind, command-line utilities, and GUI on NetBSD.
...
There are many ways to configure TsellCoin Core. Here is an example that
