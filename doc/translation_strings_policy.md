...
This document provides guidelines for internationalization of the TsellCoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to TsellCoin network</source>
        <translation>
            <numerusform>%n active connection to TsellCoin network</numerusform>
            <numerusform>%n active connections to TsellCoin network</numerusform>
        </translation>
    </message>
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `tsellcoin_en.ts` remains unchanged.
