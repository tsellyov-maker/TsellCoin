UNIX BUILD NOTES
====================
Some notes on how to build TsellCoin Core in Unix.
...
memory available when compiling TsellCoin Core. On systems with less, gcc can be
...
To build TsellCoin Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, TsellCoin Core can
