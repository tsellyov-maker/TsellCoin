...
```sh
cmake --build build --target tsellcoind tsellcoin-cli
cmake --build build --target tsellcoin-qt
cmake --build build --target bench_tsellcoin
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:tsellcoin/tsellcoin.git
```
...
> e.g. github.com/tsellcoin/tsellcoin.git or for the GUI github.com/tsellcoin-core/gui
