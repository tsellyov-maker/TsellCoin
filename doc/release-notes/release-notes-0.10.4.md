TsellCoin Core version 0.10.4 is now available from:

  <https://tsellcoin.org/bin/tsellcoin-core-0.10.4/>
...
- #6953 `43c2789` Split tsellcoin-tx into its own package
- #6953 `dfe0d4d` Include tsellcoin-tx binary on Debian/Ubuntu
