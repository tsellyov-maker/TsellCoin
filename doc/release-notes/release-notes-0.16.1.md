TsellCoin Core version 0.16.1 is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting tsellcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure tsellcoind processes are cleaned up when tests end (sdaftuar)
