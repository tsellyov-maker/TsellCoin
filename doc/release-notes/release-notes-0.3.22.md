Download URL: https://sourceforge.net/projects/tsellcoin/files/TsellCoin/tsellcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TSC fee schedule (users still pay 0.01 TSC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #tsellcoin00 - #tsellcoin99
