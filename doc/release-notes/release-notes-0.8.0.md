TsellCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tsellcoin/files/TsellCoin/tsellcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the TsellCoin
...
New/changed settings (command-line or tsellcoin.conf file)
--------------------------------------------------------
