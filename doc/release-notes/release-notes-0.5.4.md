TsellCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tsellcoin/files/TsellCoin/tsellcoin-0.5.4/
...
http://gitorious.org/tsellcoin/tsellcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix TsellCoin-Qt notifications under Growl 1.3.
Increase required age of TsellCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxTsellCoin properly when installing TsellCoin-Qt over it. (Windows)
