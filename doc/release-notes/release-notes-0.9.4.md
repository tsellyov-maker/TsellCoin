TsellCoin Core version 0.9.4 is now available from:

  https://tsellcoin.org/bin/0.9.4/
...
this update is incompatible with the TsellCoin system and could lead to consensus
forks.

TsellCoin Core released binaries from https://tsellcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tsellcoin/+archive/ubuntu/tsellcoin
- A third-party or self-compiled TsellCoin Core

upgrade to TsellCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
