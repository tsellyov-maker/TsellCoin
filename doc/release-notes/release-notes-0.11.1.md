TsellCoin Core version 0.11.1 is now available from:

  <https://tsellcoin.org/bin/tsellcoin-core-0.11.1/>
...
(see https://github.com/tsellcoin/tsellcoin/pull/6795).
...
one was randomly violated by all deployed tsellcoin software prior to
...
TsellCoin Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; TsellCoinj has done so for a similar span of time.
TsellCoinjs and electrum have been more recently updated.
...
[1] On the Malleability of TsellCoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/tsellcoin/paper_9.pdf
...
(see https://github.com/tsellcoin/tsellcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libtsellcoinconsensus: avoid a crash in multi-threaded environments
