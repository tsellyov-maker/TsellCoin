...
TsellCoin Core version 26.2 is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-26.2/>
...
using the Linux kernel, macOS 11.0+, and Windows 7 and newer.  TsellCoin
