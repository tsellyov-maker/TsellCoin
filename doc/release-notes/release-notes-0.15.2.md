TsellCoin Core version *0.15.2* is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in tsellcoin-tx (TheBlueMatt)
