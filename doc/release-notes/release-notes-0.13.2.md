TsellCoin Core version 0.13.2 is now available from:

  <https://tsellcoin.org/bin/tsellcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update tsellcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow tsellcoin-tx to create v2 transactions (btcdrak)
