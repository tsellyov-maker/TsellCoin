TsellCoin Core version 0.9.2.1 is now available from:

  https://tsellcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TSC to 0.01 TSC
...
- Fix "Start tsellcoin on system login"
