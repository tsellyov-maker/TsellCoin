TsellCoin Core version 27.0 is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-27.0/>
...
libtsellcoinconsensus
-------------------

- libtsellcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libtsellcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build TsellCoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of TsellCoin Core would
