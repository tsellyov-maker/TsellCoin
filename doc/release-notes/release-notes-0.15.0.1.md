TsellCoin Core version *0.15.0.1* is now available from:

  <https://tsellcoin.org/bin/tsellcoin-core-0.15.0.1/>

and

  <https://tsellcoincore.org/bin/tsellcoin-core-0.15.0.1/>
