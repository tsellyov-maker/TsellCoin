...
TsellCoin Core version 0.19.1 is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-0.19.1/>
...
From TsellCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as TsellCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, TsellCoin Core does not yet change appearance when
...
- #17488 fix "tsellcoind already running" warnings on macOS (fanquake)
