...
TsellCoin Core version v30.1 is now available from:

  <https://tsellcoincore.org/bin/tsellcoin-core-30.1/>
...
- #33229 multiprocess: Don't require tsellcoin -m argument when IPC options are used
...
- #33723 chainparams: remove dnsseed.tsellcoin.dashjr-list-of-p2p-nodes.us
