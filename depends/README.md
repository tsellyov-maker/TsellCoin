...
TsellCoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring TsellCoin Core

**When configuring TsellCoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring TsellCoin Core:
...
variables will be set when generating the TsellCoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
