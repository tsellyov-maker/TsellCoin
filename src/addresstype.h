 ...
 *  A CTxDestination is the internal data type encoded in a tsellcoin address
 */
...
/**
 * Generate a TsellCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
