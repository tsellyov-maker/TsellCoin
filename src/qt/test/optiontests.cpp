...
{
    // Test regression https://github.com/tsellcoin/tsellcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/tsellcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/tsellcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/TsellCoin/TsellCoin-Qt.conf and all else left as default,
    // tsellcoin-qt should set both -listen and -listenonion to false and start successfully.
