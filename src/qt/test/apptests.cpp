...
//! Entry point for TsellCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TsellCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TsellCoinGUI tests.
void AppTests::guiTests(TsellCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TsellCoinGUI::consoleShown, this, &AppTests::consoleTests);
