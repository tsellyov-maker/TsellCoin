...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TsellCoinUnits::SeparatorStyle separators=TsellCoinUnits::SeparatorStyle::STANDARD) const;
