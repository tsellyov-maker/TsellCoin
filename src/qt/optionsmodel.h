...
/** Interface from Qt to configuration data structure for TsellCoin client.
...
public:
    ...
    TsellCoinUnit getDisplayUnit() const { return m_display_tsellcoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSTSControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    TsellCoinUnit m_display_tsellcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(TsellCoinUnit unit);
