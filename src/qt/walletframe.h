 ...
 * controls into TsellCoinGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to TsellCoinGUI, thus greatly simplifying merges while
...
public Q_SLOTS:
    ...
    /** Load Partially Signed TsellCoin Transaction */
