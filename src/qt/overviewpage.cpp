...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = TsellCoinUnits::formatWithUnit(unit, amount, true, TsellCoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    TsellCoinUnit unit{TsellCoinUnit::TSC};
...
{
    TsellCoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(TsellCoinUnits::formatWithPrivacy(unit, balances.balance, TsellCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(TsellCoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, TsellCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(TsellCoinUnits::formatWithPrivacy(unit, balances.immature_balance, TsellCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(TsellCoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, TsellCoinUnits::SeparatorStyle::ALWAYS, m_privacy));
