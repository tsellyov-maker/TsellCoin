      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->tsellcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tsellcoinAtStartup);
    ...
    ui->tsellcoinAtStartup->setToolTip(ui->tsellcoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->tsellcoinAtStartup->setText(ui->tsellcoinAtStartup->text().arg(CLIENT_NAME));

    ui->openTsellCoinConfButton->setToolTip(ui->openTsellCoinConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new TsellCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tsellcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSTSControls);
...
void OptionsDialog::on_openTsellCoinConfButton_clicked()
{
