...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure TsellCoin Core copyright is not removed by accident
    if (copyright_devs.find("TsellCoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The TsellCoin Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tsellcoin/tsellcoin>";
