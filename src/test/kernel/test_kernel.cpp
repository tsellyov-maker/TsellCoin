...
#include <kernel/tsellcoinkernel_wrapper.h>
#include <util/fs.h>

#define BOOST_TEST_MODULE TsellCoin Kernel Test Suite
...
{
    Logger logger{std::make_unique<TestLog>()};
    auto test_directory{TestDirectory{"chainman_test_tsellcoin_kernel"}};
...
{
    auto test_directory{TestDirectory{"mainnet_test_tsellcoin_kernel"}};
...
{
    auto test_directory{TestDirectory{"block_tree_entry_test_tsellcoin_kernel"}};
    auto notifications{std::make_shared<TestKernelNotifications>()};
...
{
    auto in_memory_test_directory{TestDirectory{"in-memory_test_tsellcoin_kernel"}};
...
{
    auto test_directory{TestDirectory{"regtest_test_tsellcoin_kernel"}};
