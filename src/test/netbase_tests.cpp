// Copyright (c) 2012-present The TsellCoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.tsellcoincore.org", "www.tsellcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.tsellcoincore.org]", "www.tsellcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.tsellcoincore.org:80", "www.tsellcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.tsellcoincore.org]:80", "www.tsellcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.tsellcoincore.org:65536", "www.tsellcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.tsellcoincore.org:0", "www.tsellcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.tsellcoincore.org:", "www.tsellcoincore.org:", 0, false));
}
