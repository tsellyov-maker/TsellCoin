...
public:
    CMainParams() {
        ...
        nDefaultPort = 18388;
        // TsellCoin public seed node - Contabo VPS
        vSeeds.emplace_back("109.199.100.175");
...
// Stephan Oeste
// Jason Maurice
// Ava Chow, only supports x1, x5, x9, x49, x809, x849, xd, x400, x404, x408, x448, xc08, xc48, x40c
