...
extern thread_local ThreadContext g_thread_context; // NOLINT(tsellcoin-nontrivial-threadlocal)
// Silence nonstandard tsellcoin tidy error "Variable with non-trivial destructor
