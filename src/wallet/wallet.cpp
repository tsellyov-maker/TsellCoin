...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const TxState& state, const UpdateWalletTxFn& update_wtx, bool rescanning_old_block)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/tsellcoin/tsellcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/tsellcoin/tsellcoin/pull/13339#issuecomment-461288094
...
bool CWallet::LoadToWallet(const Txid& hash, const UpdateWalletTxFn& fill_wtx)
{
    ...
    // If wallet doesn't have a chain (e.g when using tsellcoin-wallet tool),
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/tsellcoin/tsellcoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/tsellcoin/tsellcoin/pull/9371 and the prior sync
        ...
        // https://github.com/tsellcoin-core/tsellcoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
 ...
 * https://tsellcointalk.org/?topic=54527, or
 * https://github.com/tsellcoin/tsellcoin/pull/1393.
 */
    ...
    if (!gArgs.GetBoolArg("-walletcrosschain", DEFAULT_WALLETCROSSCHAIN)) {
        ...
        if (batch.ReadBestBlock(locator) && locator.vHave.size() > 0 && chain.getHeight()) {
            ...
            if (chain.getBlockHash(0) != locator.vHave.back()) {
                error = Untranslated("Wallet files should not be reused across chains. Restart tsellcoind with -walletcrosschain to override.");
                return false;
            }
        }
    }
