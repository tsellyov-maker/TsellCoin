...
RPCMethod getreceivedbyaddress()
{
    return RPCMethod{
        ...
        "Returns the total amount received by the given address in transactions with at least minconf confirmations.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The tsellcoin address for transactions."},
...
RPCMethod lockunspent()
{
    return RPCMethod{
        ...
        "Updates list of temporarily unspendable outputs.\n"
                ...
                "A locked transaction output will not be chosen by automatic coin selection, when spending tsellcoins.\n"
    ...
    return RPCMethod{
        ...
        "Returns array of unspent transaction outputs\n"
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, RPCArg::Default{UniValue::VARR}, "The tsellcoin addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "tsellcoin address"},
                        },
                    },
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::NUM, "vout", "the vout value"},
                            {RPCResult::Type::STR, "address", /*optional=*/true, "the tsellcoin address"},
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid TsellCoin address: ") + input.get_str());
            }
