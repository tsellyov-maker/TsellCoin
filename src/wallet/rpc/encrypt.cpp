...
RPCMethod walletpassphrase()
{
    return RPCMethod{
        ...
        "Stores the wallet decryption key in memory for 'timeout' seconds.\n"
                "This is needed prior to performing transactions related to private keys such as sending tsellcoins\n"
            "\nNote:\n"
...
RPCMethod encryptwallet()
{
    return RPCMethod{
        ...
        "will require the passphrase to be set prior to making these calls.\n"
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending tsellcoin\n"
