...
RPCMethod getnewaddress()
{
    return RPCMethod{
        "getnewaddress",
        "Returns a new TsellCoin address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new tsellcoin address"
                },
                RPCExamples{
...
RPCMethod getrawchangeaddress()
{
    return RPCMethod{
        "getrawchangeaddress",
        "Returns a new TsellCoin address, for receiving change.\n"
...
RPCMethod setlabel()
{
    return RPCMethod{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The tsellcoin address to be associated with a label."},
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!IsValidDestination(dest)) {
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid TsellCoin address");
    }
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The tsellcoin address"},
...
RPCMethod getaddressinfo()
{
    return RPCMethod{
        "getaddressinfo",
        "Return information about the given tsellcoin address.\n"
                "Some of the information will only be present if the address is in the active wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The tsellcoin address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The tsellcoin address validated."},
...
RPCMethod walletdisplayaddress()
{
    return RPCMethod{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "tsellcoin address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
