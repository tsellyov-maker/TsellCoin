...
static RPCMethod generatetodescriptor()
{
    return RPCMethod{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated tsellcoin to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated tsellcoin to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated tsellcoin to with:\n"
...
static RPCMethod generateblock()
{
    return RPCMethod{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated tsellcoin to."},
...
// NOTE: Unlike wallet RPC (which use TSC values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCMethod getblocktemplate()
{
    return RPCMethod{
        ...
        "    https://github.com/tsellcoin/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/tsellcoin/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/tsellcoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/tsellcoin/bips/blob/master/bip-0145.mediawiki\n",
        {
        ...
        [](const RPCMethod& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    if (!lpval.isNull()) {
         ...
         *
         * getblocktemplate is unlikely to be called by tsellcoin-cli, so
...
static RPCMethod submitblock()
{
    ...
    return RPCMethod{
        ...
        "See https://en.tsellcoin.it/wiki/BIP_0022 for full specification.\n",
        {
