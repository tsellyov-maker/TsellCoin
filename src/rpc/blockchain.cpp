...
static RPCMethod waitfornewblock()
{
    return RPCMethod{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (tsellcoin-cli -rpcclienttimeout=0)",
                {
            ...
            {RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::OBJ, "prevout", "(Only if undo information is available)",
                {
                    ...
                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                    {
                        ...
                        {RPCResult::Type::STR, "address", /*optional=*/true, "The TsellCoin address (only if a well-defined address exists)"},
...
static RPCMethod scanblocks()
{
    return RPCMethod{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (tsellcoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCMethod getdescriptoractivity()
{
    return RPCMethod{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (tsellcoin-cli -rpcclienttimeout=0)",
        {
...
static RPCMethod dumptxoutset()
{
    return RPCMethod{
        ...
        "For deep rollbacks, make sure to use no RPC timeout (tsellcoin-cli -rpcclienttimeout=0) as it may take several minutes.",
        {
    ...
    const std::function<void()>& interruption_point)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/tsellcoin/tsellcoin/pull/15606#discussion_r274479369
        //
        AssertLockHeld(::cs_main);
    ...
    const std::function<void()>& interruption_point)
{
    ...
    // See also https://github.com/tsellcoin/tsellcoin/issues/25675
...
static RPCMethod loadtxoutset()
{
    return RPCMethod{
        ...
        "The result is a usable tsellcoind instance that is current with the network tip in a "
        ...
        "document (<https://github.com/tsellcoin/tsellcoin/blob/master/doc/design/assumeutxo.md>).",
        {
            {"path",
                RPCArg::Type::STR,
                RPCArg::Optional::NO,
