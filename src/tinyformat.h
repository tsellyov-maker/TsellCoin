...
#include <algorithm>
#include <attributes.h> // Added for TsellCoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for TsellCoin Core
#include <util/string.h> // Added for TsellCoin Core
...
// Added for TsellCoin Core. Similar to std::runtime_format from C++26.
...
// Added for TsellCoin Core. Wrapper for checking format strings at compile time.
